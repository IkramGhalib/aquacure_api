...
$query="SELECT eid,round(AVG(D_10)) as d10, date(datetime) from devices_logs where eid='$device_id' and substring_index(datetime, ' ', 1) = '2022-10-20' group by date(datetime)";
