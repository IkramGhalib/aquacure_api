...
$query="SELECT FROM_UNIXTIME(FLOOR(UNIX_TIMESTAMP(datetime) / (60*60)) * (60*60)) AS hourlytime, round(avg(D2_5)) as D2_5 from devices_logs where eid='$device_id' GROUP BY hourlytime ORDER BY hourlytime desc limit 7";
