...
$query="SELECT eid,round(AVG(D2_5)) as D2_5, date(datetime) from devices_logs where eid='$device_id' and substring_index(datetime, ' ', 1) = '2022-10-20' group by date(datetime)";
