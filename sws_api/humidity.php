...
$query="SELECT eid,round(AVG(humidity)) as humidity, date(datetime) from devices_logs where eid='$device_id' and substring_index(datetime, ' ', 1) = '2022-10-20' group by date(datetime)";
